        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
          <thead>
            <tr style={{ background: 'linear-gradient(135deg, #1e293b 0%, #334155 100%)', color: '#fff', borderBottom: '2px solid #0ea5e9' }}>
              <th style={{ padding: '12px 14px', textAlign: 'left', fontWeight: 600, fontSize: 12, letterSpacing: '0.5px' }}>Section</th>
              <th style={{ padding: '12px 14px', textAlign: 'left', fontWeight: 600, fontSize: 12, letterSpacing: '0.5px' }}>Focus</th>
              <th style={{ padding: '12px 14px', textAlign: 'left', fontWeight: 600, fontSize: 12, letterSpacing: '0.5px' }}>Language Target</th>
              <th style={{ padding: '12px 14px', textAlign: 'left', fontWeight: 600, fontSize: 12, letterSpacing: '0.5px' }}>Assessment</th>
            </tr>
          </thead>
          <tbody>
