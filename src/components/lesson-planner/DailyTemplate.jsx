        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
          <thead>
            <tr style={{ background: '#F3F4F6', borderBottom: '2px solid #E5E7EB' }}>
              ...
              <th style={{ padding: 10, textAlign: 'left' }}>Teacher Actions</th>
              <th style={{ padding: 10, textAlign: 'left' }}>Student Actions</th>
              <th style={{ padding: 10, textAlign: 'left' }}>Assessment</th>
            </tr>
          </thead>
          <tbody>
