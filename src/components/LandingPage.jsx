...
export default function LandingPage({ onLoginSuccess, classes, setClasses, refreshClasses, showSearchGuide, openModal, onShowPrivacy, onShowTerms, onShowAbout }) {
  ...
  const [oauthLoading, setOAuthLoading] = useState(null); // 'azure' | 'github' | null
  ...
  const handleAzureLogin = async () => {
    ...
    try {
      ...
      // Redirect happens automatically, no need to process result here
    } catch (err) {
  ...
  if (!isCapacitorApp) {
    return (
      <>
        ...
        {/* --- NAVBAR --- */}
        <nav
          aria-label="Klasiz.fun main navigation"
          style={{ ...modernStyles.nav, ...(isMobile ? modernStyles.navMobile : {}), ...(isDark ? modernStyles.navDark : {}) }}
        >
          {isMobile ? (
                ...
                {showMobileMenu && (
                  <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                      <button
                        onClick={() => { setShowDonateOverlay(true); setShowMobileMenu(false); }}
                        style={{
                          width: '100%',
                          padding: '12px 14px',
                          borderRadius: '8px',
                        ...
                        onMouseEnter={(e) => e.currentTarget.style.background = isDark ? 'rgba(239, 68, 68, 0.1)' : 'rgba(239, 68, 68, 0.08)'}
        ...
        <section
          id="home"
          aria-labelledby="klasiz-hero-heading"
          style={{ ...modernStyles.heroSection, ...(isMobile ? modernStyles.heroSectionMobile : {}) }}
        >
        <div style={modernStyles.heroContent}>
          ...
          <h1
            id="klasiz-hero-heading"
            style={{ ...modernStyles.heroTitle, ...(isMobile ? modernStyles.heroTitleMobile : {}), ...(isDark ? modernStyles.heroTitleDark : {}) }}
          >
      ...
      <section
        id="features"
        aria-labelledby="klasiz-features-heading"
        style={{ padding: isMobile ? '32px 16px' : '56px 32px' }}
      >
      <div style={{ maxWidth: 1120, margin: '0 auto' }}>
        <header style={{ marginBottom: isMobile ? 24 : 32, textAlign: isMobile ? 'left' : 'center' }}>
          <h2
            id="klasiz-features-heading"
            style={{
                  ...
                  <>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '100%', marginTop: '12px', marginBottom: '4px' }}>
                      ...
                      <OAuthButton
                        ...
                        disabled={googleLoading || (oauthLoading !== null && oauthLoading !== 'github')}
                      />
